...
[A. Download the census data](#A. Download the census data)

[B. Download the census boundary files](#B. Download the census boundary files)

[C. Match the two datasets](#C. Match the two datasets)

[D. Colour code the data to create a thematic map](#D. Colour code the data to create a thematic map)

[E. Additional descriptive elements](#E. Additional descriptive elements)

[F. Final edits and export](#F. Final edits and export)
...
7. We can now join the two tables of data together into one. **Right\-click on the boundary dataset name** in the layers list (i.e., **lct\_000b21\_e**), and **select Joins and Relates**, and then Join... (Note: if you wish, you could also join the layer to the dataset, although the steps described below will not entirely match the settings for that process.)
...
1. Right\-click on the boundary dataset name in the layers list on the left (i.e.,**lct\_000b21a\_e**), and this time **select Symbology** to open the Symbology pane.
...
1. Before formatting our map, we should edit our labels to make the data we wish to present clearer. Right\-click again on the boundary dataset name in the layers list on the left (i.e.,**lct\_000b21a\_e**) to access the**Symbology tab**. (1\) Now, click on the **Advanced symbology options** button, (2\)  and expand the Format labels header. (3\) Next to **Category**, select **Percentage** and (4\) mark that our **number represents a fraction** so we would like to **adjust it to show as a percentage**.
...
Technique: [Data Visualization](/technique/data-visualization), [Searching for maps and data](/technique/searching-maps-and-data) \| Tools: [ArcGIS Pro](/taxonomy/term/70), [CHASS Census Analyzer](/taxonomy/term/72) \| Data Format: [Statistics](/data-format/statistics), [Vector](/data-format/vector)**Date Created:** 2024\-02\-09**Updated:** 2024\-04\-12
